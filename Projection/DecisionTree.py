...
N = 6  # 污染物的个数
tr = 0.7
data = xlrd.open_workbook(r'E:\_Python\ScipPredictor\Projection\2Fuzhou2017010618.xlsx')
...
for i in range(0, N):
    ...
    output_file = open("E:\_Python\ScipPredictor\Projection\\" + item_name[i] + ".txt", 'w')
...
output_rate = open(r'E:\_Python\ScipPredictor\Projection\rate.txt', 'w')
i = 0
for r in error:
...
f.save(r'E:\_Python\ScipPredictor\Projection\error_Fuzhou.xlsx')
# f.save('F://xq//PaperLearning//ExperimentResult//error_Portland.xlsx')
